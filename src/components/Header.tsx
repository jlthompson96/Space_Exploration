...
// ⚡ Bolt: Implemented Code Splitting for Routes using React.lazy() to reduce the initial bundle size
...
const App = () => {
    return (
        <Router>
            <CommonAppBar />
            <Suspense fallback={<div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px' }}><CircularProgress /></div>}>
                <Routes>
