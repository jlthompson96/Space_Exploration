...
// ⚡ Bolt: Implemented code splitting for top-level routes to reduce initial bundle size
// Expected impact: The main bundle size should decrease as APOD, MarsPhotos, and NASANews are lazy-loaded.
